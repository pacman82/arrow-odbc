use std::{convert::TryInto, sync::{Arc, mpsc::{sync_channel, Receiver}}, thread::{JoinHandle, self}};
...
pub struct ConcurrentOdbcReader<C: Cursor> {
    ...
    receiver: Receiver<ColumnarAnyBuffer>,
}

impl<C: Cursor> ConcurrentOdbcReader<C> {
